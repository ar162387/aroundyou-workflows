...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      delivery_fee_tiers: {
        Row: {
          ...
          per_extra_distance_m: number | null
          per_extra_fee: number | null
          tier_id: string
          updated_at: string
        }
        Insert: {
      ...
      shops: {
        ...
        Relationships: [
          {
            foreignKeyName: "shops_merchant_user_id_fkey"
    ...
    Enums: {
      ...
      shop_status: "open" | "closed" | "holiday"
