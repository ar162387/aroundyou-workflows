  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-white border-0 shadow-custom-md hover:shadow-glow hover:scale-105 transition-bounce font-semibold",
        premium: "bg-gradient-accent text-white border-0 shadow-custom-lg hover:shadow-xl hover:-translate-y-1 transition-bounce font-semibold",
        glass: "bg-white/10 text-white border border-white/20 backdrop-blur-md hover:bg-white/20 transition-smooth shadow-custom-sm",
      },
      size: {
