...
CREATE TRIGGER update_delivery_fee_tiers_updated_at BEFORE UPDATE ON public.delivery_fee_tiers FOR EACH ROW EXECUTE FUNCTION public.update_delivery_fee_tiers_updated_at_column();

-- Insert default delivery fee tiers
INSERT INTO public.delivery_fee_tiers (min_distance_m, max_distance_m, delivery_fee) VALUES
(0, 300, 30.00),
(301, 500, 40.00),
(501, 700, 50.00),
(701, 1000, 60.00),
